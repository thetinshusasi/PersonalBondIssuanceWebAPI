...
using SmartContracts.Contracts.ERC20Pausable.ContractDefinition;

namespace SmartContracts.Contracts.ERC20Pausable
{
    public partial class ERC20PausableService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ERC20PausableDeployment eRC20PausableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC20PausableDeployment>().SendRequestAndWaitForReceiptAsync(eRC20PausableDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ERC20PausableDeployment eRC20PausableDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC20PausableDeployment>().SendRequestAsync(eRC20PausableDeployment);
        }

        public static async Task<ERC20PausableService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ERC20PausableDeployment eRC20PausableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, eRC20PausableDeployment, cancellationTokenSource);
            return new ERC20PausableService(web3, receipt.ContractAddress);
        }
        ...
        public ERC20PausableService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
